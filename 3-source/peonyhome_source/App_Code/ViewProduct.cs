...
{
    public void CreateView(string ProductID, string CategoryID, string ImageName, string ProductName, string Price)
    {
        ...
        if (sessionView == null)
        {
            ...
            dtView.Columns.Add("CategoryID");
            dtView.Columns.Add("ProductName");
            dtView.Columns.Add("Price");
            dtView.Columns.Add("ImageName");

            dtView.Rows.Add(new object[] { ProductID, CategoryID, ProductName, Price, ImageName });
        }
        else
        {
