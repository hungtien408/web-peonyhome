...
public partial class ad_single_product : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            string ProductMaterial = HttpUtility.HtmlDecode(FCKEditorFix.Fix(((RadEditor)row.FindControl("txtProductMaterial")).Content.Trim()));
            string ProductMaterialEn = HttpUtility.HtmlDecode(FCKEditorFix.Fix(((RadEditor)row.FindControl("txtProductMaterialEn")).Content.Trim()));
            string ProductCare = HttpUtility.HtmlDecode(FCKEditorFix.Fix(((RadEditor)row.FindControl("txtProductCare")).Content.Trim()));
            string ProductCareEn = HttpUtility.HtmlDecode(FCKEditorFix.Fix(((RadEditor)row.FindControl("txtProductCareEn")).Content.Trim()));
