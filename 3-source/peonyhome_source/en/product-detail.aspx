    ...
    <div class="container-bg">
        <div class="container">
            ...
            <asp:ListView ID="lstBreadcrum" runat="server" DataSourceID="odsBreadcrum" EnableModelValidation="True">
                <ItemTemplate>
                    <%# Container.DataItemIndex == ((System.Data.DataView)odsBreadcrum.Select()).Count - 1 ? "<span>" + Eval("ProductCategoryNameEn") + "</span>" : "<a href='" + progressTitle(Eval("ProductCategoryNameEn")) + "-pci-" + Eval("ProductCategoryID") + ".aspx" + "'>" + Eval("ProductCategoryNameEn") + "</a><span class='icon-site fa fa-angle-right'></span> "%>
                </ItemTemplate>
                <LayoutTemplate>
                    <div class="site">
                        ...
                        <div class="col-md-5">
                            <div class="central">
                                ...
                                <div class="bnt-add bnt-add2">
                                    <span class="add">
                                        <asp:LinkButton ID="lkbAddToCart" runat="server" CommandName="AddToCart" ValidationGroup="cart2">Add to cart</asp:LinkButton></span>
                                </div>
                            ...
                            <div class="menu-prod">
                                <ul class="accordion">
                                    <li>
                                        ...
                                        <div class="submenu">
                                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("ProductMaterialEn") %>'></asp:Label>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="submenu">
                                            <asp:Label ID="Label2" runat="server" Text='<%# Eval("ProductCareEn") %>'></asp:Label>
                                        </div>
                                    </li>
                                </ul>
                            </div>
