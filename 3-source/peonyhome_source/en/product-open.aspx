        ...
        <div class="container">
            ...
            <div class="site">
                <asp:ListView ID="lstBreadcrum" runat="server" DataSourceID="odsBreadcrum" EnableModelValidation="True">
                    <ItemTemplate>
                        <%# "<a href='" + progressTitle(Eval("ProductCategoryNameEn")) + "-pci-" + Eval("ProductCategoryID") + ".aspx" + "'>" + Eval("ProductCategoryNameEn") + "</a><span class='icon-site fa fa-angle-right'></span> "%>
                    </ItemTemplate>
                    <LayoutTemplate>
                            ...
                            <div class="product-img">
                                <a class="product-imgs" href='<%# progressTitle(Eval("ProductNameEn")) + "-pci-" + Eval("CategoryID") + "-pi-" + Eval("ProductID") + ".aspx" %>'>
                                    <img alt='<%# Eval("ImageName") %>' src='<%# !string.IsNullOrEmpty(Eval("ImageName").ToString()) ? "~/res/product/" + Eval("ImageName") : "~/assets/images/img1.jpg" %>'
                                        runat="server" /></a>
                                <div class="xemnhanh">
                                    <a class="link-view" href='<%# progressTitle(Eval("ProductNameEn")) + "-pv-" + Eval("ProductID") + ".aspx" %>'>
