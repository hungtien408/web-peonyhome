        ...
        if (Page.IsValid)
        {
            ...
            if (dtCart != null)
            {
                ...
                foreach (DataRow dr in dtCart.Rows)
                {
                    ...
                    Body += string.IsNullOrEmpty(ImageName) ? "<td align='center' style='padding: 5px; border-collapse: collapse; border-bottom: 1px solid #C7D7DB;'><p style='text-align:center;'>null</p></td>" : "<td align='center' style='padding: 5px; border-collapse: collapse; border-bottom: 1px solid #C7D7DB;'><img src='http://peonyhome.com.vn/res/product/album/" + ImageName + "' alt='' width='100'/></td>";
