...
namespace TLLib
{
    public class Product
    {
        ...
        public string ProductInsert(
            ...
            string ProductMaterialEn,
	        string ProductCare,
            string ProductCareEn
        )
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@ProductMaterial", string.IsNullOrEmpty(ProductMaterial) ? dbNULL : (object)ProductMaterial);
                cmd.Parameters.AddWithValue("@ProductMaterialEn", string.IsNullOrEmpty(ProductMaterialEn) ? dbNULL : (object)ProductMaterialEn);
                cmd.Parameters.AddWithValue("@ProductCare", string.IsNullOrEmpty(ProductCare) ? dbNULL : (object)ProductCare);
                cmd.Parameters.AddWithValue("@ProductCareEn", string.IsNullOrEmpty(ProductCareEn) ? dbNULL : (object)ProductCareEn);
